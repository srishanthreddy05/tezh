...
const offerings = [
  {
    ...
    desc: "Intelligent chatbots and virtual assistants that engage customers naturally — resolving queries, driving conversions, and delivering support around the clock.",
  },
  {
    number: "02",
    icon: "◈",
    title: "Voice AI",
    desc: "Voice-enabled solutions for hands-free, natural interaction — from IVR replacement to fully conversational voice agents across any channel.",
  },
  {
    number: "03",
    icon: "◎",
    title: "Process Automation Agents",
    desc: "AI-driven bots that handle complex, multi-step business processes end-to-end — making decisions, routing tasks, and escalating intelligently.",
  },
  {
    number: "04",
    icon: "◉",
    title: "Custom AI Model Training",
    desc: "Bespoke models trained on your data, tuned to your domain — delivering precision and performance that off-the-shelf solutions simply can't match.",
  },
];
...
const whyChoose = [
  {
    icon: "◈",
    title: "Technology",
    desc: "State-of-the-art LLMs, ML frameworks, and cloud-native AI platforms — always leveraging the best tools for your specific use case.",
  },
  {
    icon: "◉",
    title: "Trust",
    desc: "Ethical, transparent, and secure AI development with explainability built in — so you always know what your agents are doing and why.",
  },
  {
    icon: "◎",
    title: "Team",
    desc: "AI specialists, prompt engineers, and data scientists with real-world deployment experience across industries and scales.",
  },
];

const stats = [
  { value: "3x",   label: "Avg. Productivity Gain" },
  { value: "90%",  label: "Query Deflection Rate" },
    ...
    >
      ...
      >
        ...
        <Reveal delay={0.22}>
          ...
          >
            Automate, engage, and innovate with intelligent AI-powered agents —
            built to think, act, and deliver results without human intervention.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="sp-cta">Start Building →</a>
            <a
              href="#overview"
          ...
          <div>
            ...
            <Reveal delay={0.18}>
              <p className="sp-body text-base leading-relaxed" style={{ color: "var(--muted)" }}>
                We build conversational and process automation agents that enhance customer
                experience and streamline operations. Our AI solutions are secure, scalable,
                and tailored to your business — from lightweight chatbots to fully autonomous
                agents capable of reasoning across complex, multi-step workflows.
              </p>
            </Reveal>
          </div>
        ...
        <Reveal className="mb-14">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <p className="sp-body text-sm hidden sm:block text-right max-w-xs"
              style={{ color: "var(--muted)" }}>
              Every agent is designed, trained, and maintained end-to-end by our team.
            </p>
          </div>
        </Reveal>
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <Reveal delay={0.2}>
          <p className="sp-body text-base md:text-lg mb-10 max-w-xl mx-auto"
            style={{ color: "var(--muted)" }}>
            Get a complimentary AI readiness assessment and discover exactly where
            intelligent agents can transform your customer experience and operations.
          </p>
        </Reveal>
        <Reveal delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
