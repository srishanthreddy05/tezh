...
const offerings = [
  {
    ...
    desc: "Robust, secure network architecture and deployment engineered for seamless connectivity, high availability, and future growth.",
  },
  {
    number: "02",
    icon: "◈",
    title: "Server & Cloud Management",
    desc: "End-to-end management of on-premise and cloud infrastructure — provisioning, monitoring, patching, and cost optimization.",
  },
  {
    number: "03",
    icon: "◎",
    title: "24/7 Remote Support",
    desc: "Proactive monitoring and rapid-response engineering keep your systems healthy before issues ever reach your team.",
  },
  {
    number: "04",
    icon: "◉",
    title: "Cybersecurity Solutions",
    desc: "Layered defense strategies — endpoint protection, threat intelligence, compliance audits — guarding against evolving digital threats.",
  },
];
...
const whyChoose = [
  {
    icon: "◈",
    title: "Technology",
    desc: "Cutting-edge tools, modern best practices, and battle-tested architecture patterns deliver reliability at every layer.",
  },
  {
    icon: "◉",
    title: "Trust",
    desc: "Transparent service delivery, clear SLAs, and a proven track record with enterprises across multiple industries.",
  },
  {
    icon: "◎",
    title: "Team",
    desc: "Certified engineers and consultants who treat your infrastructure as their own — dedicated, accountable, and always available.",
  },
];
      ...
      >
        ...
        <Reveal delay={0}>
          <div className="sp-body flex items-center justify-center gap-2 mb-8 text-[0.7rem]"
            ...
            <span>/</span>
            <span style={{ color: "var(--muted)" }}>IT Services</span>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.22}>
          ...
          >
            Secure, scalable, and reliable IT infrastructure for modern business —
            engineered to keep you running at full speed.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="sp-cta">Get a Free Audit →</a>
            <a
              href="#overview"
          ...
          <div>
            ...
            <Reveal delay={0.18}>
              <p className="sp-body text-base leading-relaxed" style={{ color: "var(--muted)" }}>
                Our IT Services empower your organization with robust networks, proactive
                support, and enterprise-grade security. We design, implement, and manage
                systems that keep your business running smoothly and securely — so your
        ...
        <Reveal className="mb-14">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <p className="sp-body text-sm hidden sm:block text-right max-w-xs"
              style={{ color: "var(--muted)" }}>
              Every offering is scoped, delivered, and supported end-to-end by our team.
            </p>
          </div>
        </Reveal>
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <Reveal delay={0.2}>
          <p className="sp-body text-base md:text-lg mb-10 max-w-xl mx-auto"
            style={{ color: "var(--muted)" }}>
            Get a complimentary infrastructure audit and discover exactly where
            we can add reliability, security, and efficiency.
          </p>
        </Reveal>
        <Reveal delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
