...
const offerings = [
  {
    ...
    icon: "⬡",
    title: "Mobile Apps",
    desc: "Native and cross-platform iOS and Android apps — performant, polished, and built around the way your users actually move through the world.",
  },
  {
    number: "02",
    icon: "◈",
    title: "Web Applications",
    desc: "Modern, scalable web apps engineered for speed and reliability — from internal tools to customer-facing platforms that handle real-world load.",
  },
  {
    number: "03",
    icon: "◎",
    title: "Custom Solutions",
    desc: "Bespoke software designed around your exact workflows and constraints — no off-the-shelf compromises, just precise solutions that fit like a glove.",
  },
  {
    number: "04",
    icon: "◉",
    title: "API Integrations",
    desc: "Robust, well-documented APIs and third-party integrations that unify your systems, eliminate data silos, and power seamless cross-platform experiences.",
  },
];
...
const whyChoose = [
  {
    icon: "◈",
    title: "Technology",
    desc: "The latest frameworks, proven architecture patterns, and modern DevOps practices — delivering software that's built to last and easy to evolve.",
  },
  {
    icon: "◉",
    title: "Trust",
    desc: "Transparent process, clear milestones, and reliable delivery — you always know where your project stands and what's coming next.",
  },
  {
    icon: "◎",
    title: "Team",
    desc: "Experienced engineers, UX designers, and product strategists who treat your vision as their own — from first brief to final deployment.",
  },
];
      ...
      >
        ...
        <Reveal delay={0}>
          <div className="sp-body flex items-center justify-center gap-2 mb-8 text-[0.7rem]"
            ...
            <span>/</span>
            <span style={{ color: "var(--muted)" }}>App & Software Development</span>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.22}>
          ...
          >
            Build custom apps and software that drive your business forward —
            crafted with precision, shipped on time, and built to scale.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="sp-cta">Start Your Project →</a>
            <a
              href="#overview"
          ...
          <div>
            ...
            <Reveal delay={0.18}>
              <p className="sp-body text-base leading-relaxed" style={{ color: "var(--muted)" }}>
                From mobile to web, we design and develop applications that are robust,
                scalable, and user-centric. Our team delivers solutions that fit your vision
                and goals — blending product thinking with engineering excellence to create
                software your customers will actually love to use.
              </p>
            </Reveal>
          </div>
        ...
        <Reveal className="mb-14">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <p className="sp-body text-sm hidden sm:block text-right max-w-xs"
              style={{ color: "var(--muted)" }}>
              Every product is scoped, designed, and shipped end-to-end by our team.
            </p>
          </div>
        </Reveal>
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <Reveal delay={0.2}>
          <p className="sp-body text-base md:text-lg mb-10 max-w-xl mx-auto"
            style={{ color: "var(--muted)" }}>
            Share your idea and get a complimentary scoping session — we'll map
            out the right approach, stack, and timeline to bring your vision to life.
          </p>
        </Reveal>
        <Reveal delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
