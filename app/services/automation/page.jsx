...
const offerings = [
  {
    ...
    desc: "Automate repetitive, rule-based tasks with intelligent bots — freeing your team to focus on high-value work while reducing errors and operational costs.",
  },
  {
    number: "02",
    icon: "◈",
    title: "Workflow Integration",
    desc: "Seamlessly connect disparate systems, applications, and data sources into unified, end-to-end automated pipelines that eliminate manual handoffs.",
  },
  {
    number: "03",
    icon: "◎",
    title: "Custom Automation Development",
    desc: "Tailored automation solutions built around your unique business logic — from scripting and orchestration to full-scale process re-engineering.",
  },
];
...
const whyChoose = [
  {
    icon: "◈",
    title: "Technology",
    desc: "Advanced automation platforms, proven RPA frameworks, and modern integration tooling deliver scalable, future-ready solutions.",
  },
  {
    icon: "◉",
    title: "Trust",
    desc: "Secure, auditable, and transparent automation delivery with clear SLAs and measurable ROI from day one.",
  },
  {
    icon: "◎",
    title: "Team",
    desc: "Certified process engineers and automation architects who embed with your team to design, deploy, and continuously improve every workflow.",
  },
];
      ...
      >
        ...
        <Reveal delay={0}>
          <div className="sp-body flex items-center justify-center gap-2 mb-8 text-[0.7rem]"
            ...
            <span>/</span>
            <span style={{ color: "var(--muted)" }}>Automation Solutions</span>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.22}>
          ...
          >
            ...
            built to eliminate friction and unlock your team's full potential.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="sp-cta">Get a Free Consultation →</a>
            <a
              href="#overview"
          ...
          <div>
            ...
            <Reveal delay={0.18}>
              <p className="sp-body text-base leading-relaxed" style={{ color: "var(--muted)" }}>
                We help you automate business processes, reduce manual effort, and unlock
                new levels of productivity. Our solutions are secure, scalable, and tailored
                to your goals — from simple task automation to complex, multi-system
                orchestration that transforms how your organization operates.
              </p>
            </Reveal>
          </div>
        ...
        <Reveal className="mb-14">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <p className="sp-body text-sm hidden sm:block text-right max-w-xs"
              style={{ color: "var(--muted)" }}>
              Every solution is scoped, delivered, and supported end-to-end by our team.
            </p>
          </div>
        </Reveal>
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <Reveal delay={0.2}>
          <p className="sp-body text-base md:text-lg mb-10 max-w-xl mx-auto"
            style={{ color: "var(--muted)" }}>
            Get a complimentary process audit and discover exactly where automation
            can save time, reduce costs, and accelerate your operations.
          </p>
        </Reveal>
        <Reveal delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
