...
const offerings = [
  {
    ...
    desc: "In-depth analysis of your current digital landscape — mapping systems, processes, and gaps to build a crystal-clear picture of where you are and what's holding you back.",
  },
  {
    number: "02",
    icon: "◈",
    title: "Strategy & Roadmap",
    desc: "Clear, actionable transformation plans aligned to your business goals — prioritized initiatives, realistic timelines, and measurable milestones that keep momentum high.",
  },
  {
    number: "03",
    icon: "◎",
    title: "Implementation",
    desc: "Seamless execution of transformation initiatives — from technology rollouts and process redesign to change management programs that bring your people along for the journey.",
  },
  {
    number: "04",
    icon: "◉",
    title: "Optimization",
    desc: "Continuous improvement cycles that ensure lasting business value — monitoring outcomes, refining workflows, and evolving your digital capability long after go-live.",
  },
];
...
const whyChoose = [
  {
    icon: "◈",
    title: "Technology",
    desc: "Proven digital transformation frameworks, modern cloud platforms, and battle-tested tooling — chosen for your context, not sold from a catalogue.",
  },
  {
    icon: "◉",
    title: "Trust",
    desc: "Transparent, collaborative, and results-driven throughout — no jargon, no bloated timelines, just honest delivery against clear success metrics.",
  },
  {
    icon: "◎",
    title: "Team",
    desc: "Experienced change leaders, enterprise architects, and digital experts who've navigated complex transformations — and know how to bring organizations with them.",
  },
];
...
const stats = [
  ...
  { value: "50+",  label: "Transformations Delivered" },
  { value: "100%", label: "Stakeholder Alignment Focus" },
];
    ...
    >
      ...
      >
        ...
        <Reveal delay={0.22}>
          ...
          >
            Modernize, optimize, and scale your business for the digital era —
            from strategic assessment through to full execution and continuous improvement.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="sp-cta">Start Your Assessment →</a>
            <a
              href="#overview"
          ...
          <div>
            ...
            <Reveal delay={0.18}>
              <p className="sp-body text-base leading-relaxed" style={{ color: "var(--muted)" }}>
                We help you navigate digital change from assessment to execution. Our
                transformation services are designed to deliver measurable results and
                sustainable growth — combining strategic clarity with hands-on delivery
                so that modernization efforts don't just launch, they last.
              </p>
            </Reveal>
          </div>
        ...
        <Reveal className="mb-14">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <p className="sp-body text-sm hidden sm:block text-right max-w-xs"
              style={{ color: "var(--muted)" }}>
              A proven four-phase approach — structured, collaborative, and built for results.
            </p>
          </div>
        </Reveal>
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <Reveal delay={0.2}>
          <p className="sp-body text-base md:text-lg mb-10 max-w-xl mx-auto"
            style={{ color: "var(--muted)" }}>
            Get a complimentary digital readiness assessment and discover exactly
            where transformation can unlock efficiency, agility, and competitive advantage.
          </p>
        </Reveal>
        <Reveal delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
