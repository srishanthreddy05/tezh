...
const offerings = [
  {
    ...
    desc: "Centralized, secure storage architecture for all your business data — structured for speed, governed for compliance, and built to grow with you.",
  },
  {
    number: "02",
    icon: "◈",
    title: "Dashboards & Reporting",
    desc: "Real-time visualizations and automated reports that surface the right information to the right people — turning raw numbers into clear, decisive action.",
  },
  {
    number: "03",
    icon: "◎",
    title: "Predictive Analytics",
    desc: "Forecast trends, model outcomes, and anticipate risk with advanced ML-powered analytics — so you're always a step ahead of what's coming.",
  },
  {
    number: "04",
    icon: "◉",
    title: "KPI Optimization",
    desc: "Define, track, and systematically improve your most critical metrics — with the visibility and tooling to move the numbers that actually matter.",
  },
];
...
const whyChoose = [
  {
    icon: "◈",
    title: "Technology",
    desc: "Modern analytics stacks, cloud-native data platforms, and best-in-class BI tooling — engineered for performance at any data volume.",
  },
  {
    icon: "◉",
    title: "Trust",
    desc: "Data privacy, security, and regulatory compliance baked into every layer — so your data stays yours and your customers stay protected.",
  },
  {
    icon: "◎",
    title: "Team",
    desc: "Experienced data scientists, analytics engineers, and BI consultants who translate complexity into clarity — and insights into outcomes.",
  },
];
      ...
      >
        ...
        <Reveal delay={0}>
          <div className="sp-body flex items-center justify-center gap-2 mb-8 text-[0.7rem]"
            ...
            <span>/</span>
            <span style={{ color: "var(--muted)" }}>Data Analytics</span>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.05}>
          <span className="sp-body inline-flex items-center gap-3 text-[0.62rem] tracking-[0.3em] uppercase mb-7"
            ...
            Insights, BI & Predictive Analytics
            <span className="inline-block w-8 h-[1px] bg-white/15" />
          </span>
        </Reveal>
        ...
        <Reveal delay={0.22}>
          ...
          >
            ...
            with analytics infrastructure built for clarity, speed, and scale.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="sp-cta">Get a Data Audit →</a>
            <a
              href="#overview"
          ...
          <div>
            ...
            <Reveal delay={0.18}>
              <p className="sp-body text-base leading-relaxed" style={{ color: "var(--muted)" }}>
                Our analytics solutions help you unlock the full value of your data, drive
                better decisions, and gain a genuine competitive edge. We deliver secure,
                scalable, and insightful analytics tailored to your needs — from foundational
                data infrastructure to advanced predictive models that anticipate what's next.
              </p>
            </Reveal>
          </div>
        ...
        <Reveal className="mb-14">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <p className="sp-body text-sm hidden sm:block text-right max-w-xs"
              style={{ color: "var(--muted)" }}>
              Every solution is architected, delivered, and supported end-to-end by our team.
            </p>
          </div>
        </Reveal>
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <Reveal delay={0.2}>
          <p className="sp-body text-base md:text-lg mb-10 max-w-xl mx-auto"
            style={{ color: "var(--muted)" }}>
            Get a complimentary data audit and discover exactly where better analytics
            can reduce cost, sharpen decisions, and accelerate your growth.
          </p>
        </Reveal>
        <Reveal delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
